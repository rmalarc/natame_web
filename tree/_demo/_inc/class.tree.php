...
class json_tree extends _tree_struct { 
	function __construct($table = "tree", $fields = array(), $add_fields = array("title" => "title", "type" => "type","from"=>"from","to"=>"to")) {
	...
	function get_children($data) {
		...
		foreach($tmp as $k => $v) {
			$result[] = array(
				"attr" => array("id" => "node_".$k, "rel" => $v[$this->fields["type"]],"from" => $v[$this->fields["from"]],"to" => $v[$this->fields["to"]]),

...
//	alert(tid);
	alert("This option tells the bayesian classifier to treat tweets like this as JUNK or NOT JUNK.\nDEMO ONLY - NOT DOING ANYTHING");
//		$("#images div:nth-child("+(n+1)+")").hide();
} 
 

function rebuildIsJunk(){
	alert("This option rebuilds the probabilities for tweets based on changes to the classification.\nDEMO ONLY- NOT DOING ANYTHING");
}
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
  ...
  <tr>
    <td colspan="2" bgcolor="#FFC9BB" class="cellunderlined"><span class="style1 style2">DEMO - Bayesian Classifier Results</span></td>
  </tr>
  <tr>

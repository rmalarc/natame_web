 ...
 *
 * SOURCE: http://morglog.alleycatracing.com/wordpress/?p=22
*/
    class Bayeux
    {
        private $oCurl = '';
...
<?
//phpinfo();
//$oPhomet = new Bayeux('http://natame.com:8080/dojo-examples/echo');
/*
$oPhomet = new Bayeux('http://natame.com:8080/cometd');

$oPhomet->publish('/stock/MAB', array('symbol' => 'MAB','oldValue'=>'xxx','newValue'=>date("Y-m-d H:i:s")));
*/
?>
